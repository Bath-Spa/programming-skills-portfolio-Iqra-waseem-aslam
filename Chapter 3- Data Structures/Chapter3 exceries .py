...
# maryam can't make it! Let's invite Gary instead.
del(guests[1])
guests.insert(1, 'shera')
...
guests.insert(0, 'issra')
guests.insert(2, 'khajida')
guests.append('rabia')
name = guests[0].title()
print(f"{name}, please come to dinner.")
name = guests[1].title()
...
locations = ['bisma', 'sara', 'fatima', 'asfa', 'mona']
